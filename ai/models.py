...
from cpanel.models import PhysicianPatientAppointment, Physician, PhysicianClinicWorkingTime, Clinic, PhysicianHospitalWorkingTime, Hospital, Patient, Stakeholders, PhysicianRating, ClinicRating, HospitalRating, MedicalInstitutions, MedicalInstitutionsAddress, MedicalInstitutionsPhone, PhysicianSpecialization, Specialization
