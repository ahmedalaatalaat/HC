...
def Save_All_Doctors_In_Recommendation_Data_Base(NN):
    try:
        ...
        booking_count = []
        specialization_id = []
        # print(PhysicianRecommendation.objects.all(),"WWWWWWWWWWWWWWWWWWWWWWWWW")
        ...
        #     print(i,"physician_nn")
        # for i in physicianrating_values:
        #     print(i,"physicianrating_values")
        ...
        # print(my_dict_sp,"specialization")
