# Generated by Django 2.2.7 on 2020-01-30 16:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female')], db_column='Gender', max_length=6, null=True)),
                ('stakeholder_type', models.CharField(blank=True, choices=[('Admin', 'Admin'), ('Patient', 'Patient'), ('Physician', 'Physician'), ('Nurse', 'Nurse'), ('Paramedic', 'Paramedic'), ('Pharmist', 'Pharmist'), ('Specialist', 'Specialist'), ('Clerk', 'Clerk'), ('Editors', 'Editors')], db_column='Stakeholder_Type', max_length=10, null=True)),
                ('email', models.CharField(blank=True, db_column='Email', max_length=320, null=True)),
        ...
        migrations.CreateModel(
            name='MedicalInstitutionsAdress',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time', models.DateTimeField(db_column='Date_Time')),
                ('visitation_type', models.CharField(blank=True, choices=[('Normal', 'Normal'), ('Consultation', 'Consultation'), ('Operation', 'Operation'), ('ER', 'ER')], db_column='Visitation_Type', max_length=12, null=True)),
