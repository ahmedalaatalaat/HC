...
class Stakeholders_admin(admin.ModelAdmin):
    ...
    list_display = ['national_number','stakeholder_name','stakeholder_last_name'
    ,'birthday','gender','stakeholder_type','email','marital_status','image','nationality','cv','created_at'
    ,'updated_at','hide','user']
...
admin.site.register(Stakeholders,Stakeholders_admin)
admin.site.register(StakeholdersPhones,StakeholdersPhones_admin)
admin.site.register(StakeholdersAddress,StakeholdersAddress_admin)
admin.site.register(Patient,Patient_admin)
admin.site.register(PatientRelativesPhones,PatientRelativesPhones_admin)
admin.site.register(Physician,Physician_admin)
admin.site.register(Nurse,Nurse_admin)
admin.site.register(NurseSpecialization,NurseSpecialization_admin)
admin.site.register(Paramedic,Paramedic_admin)
admin.site.register(Specialist,Specialist_admin)
admin.site.register(SpecialistSpecialization,SpecialistSpecialization_admin)
admin.site.register(Pharmacist,Pharmacist_admin)
admin.site.register(PharmacistSpecialization,PharmacistSpecialization_admin)
admin.site.register(MedicalInstitutions,MedicalInstitutions_admin)
admin.site.register(MedicalInstitutionsPhone,MedicalInstitutionsPhone_admin)
admin.site.register(MedicalInstitutionsAddress,MedicalInstitutionsAddres_admin)
admin.site.register(Labs,Labs_admin)
admin.site.register(LabsAnalysisAndRadiology,LabsAnalysisAndRadiology_admin)
...
admin.site.register(InsuranceCompanies,InsuranceCompanies_admin)
admin.site.register(InsuranceCompaniesPhone,InsuranceCompaniesPhone_admin)
admin.site.register(InsuranceCompaniesAddress,InsuranceCompaniesAddress_admin)
admin.site.register(InsuranceTypes,InsuranceTypes_admin)
admin.site.register(Specialization,Specialization_admin)
admin.site.register(PatientHistory,PatientHistory_admin)
admin.site.register(PhysicianPatientAppointment,PhysicianPatientAppointment_admin)
admin.site.register(PhysicianHospitalWorkingTime,PhysicianHospitalWorkingTime_admin)
admin.site.register(PhysicianClinicWorkingTime,PhysicianClinicWorkingTime_admin)
admin.site.register(PhysicianRating,PhysicianRating_admin)
admin.site.register(LabRating,LabRating_admin)
admin.site.register(ClinicRating,ClinicRating_admin)
admin.site.register(HospitalRating,HospitalRating_admin)
admin.site.register(HospitalNurses,HospitalNurses_admin)
admin.site.register(ClinicNurses,ClinicNurses_admin)
admin.site.register(LabNurses,LabNurses_admin)
admin.site.register(LabSpecialists,LabSpecialists_admin)
admin.site.register(HospitalSpecialists,HospitalSpecialists_admin)
admin.site.register(ClinicSpecialists,ClinicSpecialists_admin)
admin.site.register(PharmacyPharmacists,PharmacyPharmacists_admin)#---
admin.site.register(PhysicianSpecialization,PhysicianSpecialization_admin)
admin.site.register(HospitalSpecialization,HospitalSpecialization_admin)
admin.site.register(ClinicSpecialization,ClinicSpecialization_admin)
admin.site.register(LabsInsuranceDeals,LabsInsuranceDeals_admin)
admin.site.register(ClinicsInsuranceDeals,ClinicsInsuranceDeals_admin)
admin.site.register(HospitalInsuranceDeals,HospitalInsuranceDeals_admin)
admin.site.register(PharmacyInsuranceDeals,PharmacyInsuranceDeals_admin)
admin.site.register(PatientInsurance,PatientInsurance_admin)
