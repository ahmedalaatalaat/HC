...
urlpatterns = [
    ...
    path('patient_history_edit/', views.Patient_history_edit, name='patient_history_edit'),
    ...
    path('specialist_edit/', views.Specialist_edit, name='specialist_edit'),
    ...
    path('specialization_edit/', views.Specialization_edit, name='specialization_edit'),
    ...
    path('insurance_company_edit/', views.Insurance_Company_edit, name='insurance_company_edit'),
    ...
    path('insurance_type_edit/', views.Insurance_Type_edit, name='insurance_type_edit'),
    path('insurance_type_list/', views.Insurance_Type_list, name='insurance_type_list'),
    # Lab URLs
    path('lab_add/', views.Lab_add, name='lab_add'),
    path('lab_edit/', views.Lab_edit, name='lab_edit'),
    ...
    path('medical_institution_edit/', views.Medical_Institution_edit, name='lab_edit'),
