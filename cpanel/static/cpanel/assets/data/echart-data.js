$(function (e) {
    ...
    /* Beijing chart*/
    var dom = document.getElementById("echart_beijing");
    ...
    /* Weather chart*/
    var chart = document.getElementById('echart_weather');
    var weather = echarts.init(chart);
    weather.setOption({
        title: {
            text: "Weekly Weather",
            subtext: ""
    ...
    /* Scatter chart*/
    var chart = document.getElementById('echart_scatter');
    var scatter = echarts.init(chart);
    ...
    /* Candle chart*/
    var chart = document.getElementById('echart_candle');
    var candle = echarts.init(chart);
    candle.setOption({
        title: {
            text: ""
        },
